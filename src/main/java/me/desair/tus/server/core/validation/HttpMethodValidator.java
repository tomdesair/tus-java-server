...
public class HttpMethodValidator extends AbstractRequestValidator {
    ...
    @Override
    public void validate(HttpMethod method, HttpServletRequest request, final UploadStorageService uploadStorageService, final UploadIdFactory idFactory) throws TusException {
        if(method == null) {
