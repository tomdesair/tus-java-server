...
public class TusServletRequestTest {
    ...
    public void testGetContentInputStream() throws Exception {
        ...
        when(servletRequest.getInputStream()).thenReturn(new MockServletInputStream(new ByteArrayInputStream(data)));
    ...
    public void testGetContentInputStreamWithChecksum() throws Exception {
        byte[] data = "test data".getBytes();
        when(servletRequest.getInputStream()).thenReturn(new MockServletInputStream(new ByteArrayInputStream(data)));
        when(servletRequest.getHeader(HttpHeader.UPLOAD_CHECKSUM)).thenReturn("sha1 9I3YU4IIYIFsddVND1hNyGMyenw=");
        ...
        assertThat(request.getCalculatedChecksum(ChecksumAlgorithm.SHA1), is("9I3YU4IIYIFsddVND1hNyGMyenw="));
    }
